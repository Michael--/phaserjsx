...
Current docs target `@number10/phaserjsx@4.5.0`, including the standalone stencil clip extension for native Phaser Containers, the newer public UI components such as Checkbox, ProgressBar, Badge, Popover, ContextMenu, BottomSheet, ListBox, WheelPicker, Toast, Toolbar, SegmentedControl, ColorPicker, PalettePicker, NumberInput, ActivityIndicator, ProgressView, and RatingBar, plus the refreshed Button/theme control surfaces.
