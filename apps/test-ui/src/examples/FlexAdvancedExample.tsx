...
export function FlexAdvancedExample() {
  ...
  return (
    <ViewLevel1 width={800} height={'calc(100% + 200px)'}>
      <ViewLevel2>
        ...
        <View direction="row" gap={5} alignItems="start">
          ...
          <View direction="column" gap={5}>
            <Text text="1. FlexShrink - Proportional Shrinking" style={tokens?.textStyles.large} />
            <Text
        ...
        <View direction="column" gap={5}>
          <Text text="3. Prevent Shrinking with flexShrink={0}" style={tokens?.textStyles.large} />
          <Text
